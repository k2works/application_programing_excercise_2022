...
(
    ...
    customer_number            VARCHAR(40)    NOT NULL REFERENCES orders.customer (customer_number),
...
(
    ...
    product_number    INTEGER     NOT NULL REFERENCES orders.product (product_number),
    product_name      VARCHAR(40) NOT NULL,
    order_number      INTEGER     NOT NULL REFERENCES orders.received_order_line (order_number),
    order_line_number INTEGER     NOT NULL REFERENCES orders.received_order_line (order_line_number),
