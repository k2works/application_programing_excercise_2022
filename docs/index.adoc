...
image::images/schemaspy/postgresql/auth/diagrams/summary/relationships.real.large.png[]

===== 注文スキーマ

image::images/schemaspy/postgresql/orders/diagrams/summary/relationships.real.large.png[]

===== 在庫スキーマ

image::images/schemaspy/postgresql/inventories/diagrams/summary/relationships.real.large.png[]
