...
ALTER TABLE supplier_mst
    ...
    go
ALTER TABLE supplier_mst
    ADD CHECK (pay_method_type IN (1, 2)) go
...
ALTER TABLE pay
    ...
    go
ALTER TABLE pay
    ADD CHECK (complete_flg IN (0, 1)) go
...
ALTER TABLE companys_mst
    ...
    go
ALTER TABLE companys_mst
    ADD CHECK (no_sales_flg IN (0, 1)) go
